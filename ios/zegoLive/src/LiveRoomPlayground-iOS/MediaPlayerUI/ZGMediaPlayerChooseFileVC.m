...
- (void)loadNetworkMediaItems {
    ...
    [ZGMediaPlayerMediaItem itemWithFileUrl:@"https://big-class-test.oss-cn-hangzhou.aliyuncs.com/69732.1595404372304.mp4" mediaName:@"BIBILI.mp4" isVideo:YES],
    [ZGMediaPlayerMediaItem itemWithFileUrl:@"http://114.236.93.153:8080/download/video/15songs.mp4 " mediaName:@"15songs.mp4" isVideo:YES],
    [ZGMediaPlayerMediaItem itemWithFileUrl:@"http://114.236.93.153:8080/download/video/lf_360p.flv" mediaName:@"lx_360p.mp4" isVideo:YES],
    [ZGMediaPlayerMediaItem itemWithFileUrl:@"http://114.236.93.153:8080/download/video/lx_480p.flv" mediaName:@"lx_480p.mp4" isVideo:YES],
    [ZGMediaPlayerMediaItem itemWithFileUrl:@"http://114.236.93.153:8080/download/video/lx_720p.flv" mediaName:@"lx_720p.mp4" isVideo:YES],
    [ZGMediaPlayerMediaItem itemWithFileUrl:@"http://114.236.93.153:8080/download/video/1080p30fps.flv" mediaName:@"1080p30fps.mp4" isVideo:YES]];
